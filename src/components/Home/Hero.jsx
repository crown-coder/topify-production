...
import Demo from '../../assets/home/de'
        ...
        <section className='w-full min-h-dvh bg-[#F8FBF8] flex flex-col gap-16 items-center'>
            ...
            <div className='w-full text-center flex flex-col items-center gap-5 max-lg:gap-7'>
                <div className='relative max-lg:w-[90%]'>
                    ...
                    <h1 className='text-5xl max-lg:text-2xl font-medium leading-[70px]'>
                        The <span className='text-[#057DD1]'>Best</span> choice for your<br />
                        Virtual <span className='text-[#057DD1]'>Top-Up</span> Services
                    </h1>
                    <p className='text-lg max-lg:text-sm text-[#000000D9] mt-7'>
                        We offer a wide range of mobile network services, enabling users to<br className='max-lg:hidden' /> 
                        recharge airtime and data across various networks with ease.
                    </p>
                </div>

                {/* Video Section */}
                <div className='w-[80%] max-w-[800px] h-[450px] max-lg:h-[250px] bg-black rounded-xl overflow-hidden shadow-lg mt-5'>
