                ...
                <table className='min-w-[1200px] w-full border-collapse'>
                    <thead className='bg-gray-50'>
                        <tr className='text-center text-[#969a9b] text-[12px]'>
                            ...
                            <th className='p-3 font-semibold min-w-[130px] whitespace-nowrap border-b'>S/N</th>
                            <th className='p-3 font-semibold min-w-[130px] whitespace-nowrap border-b'>Name</th>
                            <th className='p-3 font-semibold min-w-[130px] whitespace-nowrap border-b'>Phone Number</th>
                            <th className='p-3 font-semibold min-w-[130px] whitespace-nowrap border-b'>Email</th>
                            <th className='p-3 font-semibold min-w-[130px] whitespace-nowrap border-b'>Package</th>
                            <th className='p-3 font-semibold min-w-[130px] whitespace-nowrap border-b'>Wallet Balance</th>
                            <th className='p-3 font-semibold min-w-[130px] whitespace-nowrap border-b'>Date Registered</th>
                            <th className='p-3 font-semibold min-w-[130px] whitespace-nowrap border-b'>Referred By</th>
                            <th className='p-3 font-semibold min-w-[130px] whitespace-nowrap border-b'>Last Login</th>
                            <th className='p-3 font-semibold min-w-[130px] whitespace-nowrap border-b'>View Details</th>
                            <th className='p-3 font-semibold min-w-[130px] whitespace-nowrap border-b'>Reset Password</th>
                            <th className='p-3 font-semibold min-w-[130px] whitespace-nowrap border-b'>Edit</th>
                            <th className='p-3 font-semibold min-w-[130px] whitespace-nowrap border-b'>Delete</th>
                        </tr>
                    </thead>
                    <tbody className='bg-white divide-y divide-gray-200'>
                        {currentRows.map((row) => (
                            <tr key={row.id} className={`text-center text-[11px] font-semibold text-gray-800 ${selectedRows.includes(row.id) ? "bg-blue-50" : ""}`}>
                                <td className='p-3'>
                                    <input
                                        type="checkbox"
