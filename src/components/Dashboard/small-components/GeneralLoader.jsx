const GeneralLoader = () => {
    return (
        <div className="flex justify-center items-center h-64">
            <div className="relative flex flex-col items-center justify-center gap-6 bg-gradient-to-br dark:from-gray-900 dark:to-gray-800">
                {/* Multi-colored gradient spinner */}
                <div className="relative">
                    {/* Outer ring with gradient */}
                    <div className="w-20 h-20 rounded-full border-[6px] border-transparent border-t-[#4CACF0] border-r-blue-500 border-b-blue-200 border-l-[#4CACF0] animate-spin [animation-duration:2s]" />
