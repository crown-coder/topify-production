...
const Accounts = () => {
    ...
    return (
        <div className='p-5 bg-white dark:bg-gray-800 w-full my-2 rounded-xl'>
            ...
            <div className='m-3 max-lg:mx-0 lg:mx-0  grid grid-cols-2 lg:grid-cols-3 gap-3'>
                <AccountCard className="bg-[#AE328E]" bankIcon={Wema} bankName="Wema Bank PLC" accountName="Jeff Grimes" accountNumber="0048932093" />
                <AccountCard iconBack="w-[60px] h-[60px] rounded-full bg-gray-800 flex items-center justify-center" className="bg-[#F1454A]" bankIcon={Sterlling} bankName="Sterling Bank" accountName="Jeff Grimes" accountNumber="0048932093" />
